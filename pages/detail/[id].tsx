      ...
      <div className="container bg-dark text-light">
        ...
        <div className="row pl-5 pr-5 pt-3">
          <div className="col-md-3">
            ...
            <div className="mb-5">
              <div className="display-4 font-weight-bold">
                {(workout.workoutMetrics.calories.value / 60).toFixed(1)}
              </div>
              <h2>Cal. per Minute</h2>
            </div>
          </div>
        ...
        <hr style={{ borderTop: "1px solid #808080" }} />
        <div>
          <p className="text-muted mb-0 text-right pt-0 pb-3">@gregavola</p>
        </div>
      </div>
    </Layout>
  );
